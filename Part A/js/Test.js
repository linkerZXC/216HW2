...
import { Person, Employee, Student, Undergradutates } from "./People.js";
...
// DEMONSTRATE ADD UNDERGRADUATES
addPersonToHashTable(new Undergradutates(hashTable.generateKey(), "Ringo", "Starr", 3.7, "U4"), hashTable);
printHashTable("\nAfter Adding 1 undergraduate", hashTable);